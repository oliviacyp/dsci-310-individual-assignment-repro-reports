...
```{r horse-pops-plot, echo = FALSE, fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972"}
...
knitr::kable(horses_sd_table, caption = "Standard deviations of horse populations of all provinces in Canada")
```
...
```{r horse-pop-plot-largest-sd, echo = FALSE, out.width="60%", fig.cap = "Horse populations for the province with the largest standard deviation"}
